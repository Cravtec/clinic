...
class Appointment(models.Model):
    ...
    def __str__(self):
        return f'{self.date} - {self.profile.first_name}: {self.doctor.first_name}'
...
class VisitDescription(models.Model):
    appointment = models.ForeignKey(user_models.User, null=True, on_delete=models.DO_NOTHING)
...
class Prescription(models.Model):
    ...
    def __str__(self):
        return f'{self.appointment} - {self.date}'
