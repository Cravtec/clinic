...
class Payment(models.Model):
    ...
    appointment = models.OneToOneField(Appointment, null=True, on_delete=models.CASCADE, related_name='payment')
...
class VisitDescription(models.Model):
    appointment = models.OneToOneField(Appointment, null=True, on_delete=models.CASCADE, related_name='visit')
...
class Prescription(models.Model):
    ...
    date = models.DateField(auto_now_add=True, null=True, blank=True)
    appointment = models.OneToOneField(Appointment, null=True, on_delete=models.CASCADE, related_name='prescription')
