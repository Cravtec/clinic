...
var appointmentPicked = document.getElementById("id_date")
var appointmentDatePicked = document.getElementById("appointmentDate")
var months = "";
var days = "";
        ...
        for (var j = 0; j < 7; j++) {
            if (i === 0 && j < firstDay) {
                ...
                cell.onclick = function(event) {
                    ...
                    appointmentDatePicked.setAttribute('value',date + " " + monthsArr[month] + " " + year)
                    appointmentPicked.setAttribute('value', year + "-" + month_val + "-" + date)
